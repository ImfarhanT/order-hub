...
# 🚚 Deploy Shipments Table to Railway PostgreSQL (FIXED) 🚚
# This script will create the shipments table in your Railway database

echo "🚚 Starting Shipments Table Deployment to Railway (Fixed Version)..."
...
# SQL to create the shipments table (with correct column names)
SQL="
